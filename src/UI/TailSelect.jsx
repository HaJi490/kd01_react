...
export default function TailSelect({id, refSel, ops, handleChange}) {
  ...
  // <form className="max-w-md mx-auto mb-3">
    ...
    //bg-transparent #투명
            className="block py-2.5 px-0 mb-3 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-stone-200  dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
